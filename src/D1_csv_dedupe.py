"""
This code demonstrates how to use dedupe the applications file 
"""
...
if __name__ == '__main__':
    ...
    input_file = './data/app-with-uuid.csv'
    output_file = './data/applications-deduped.csv'
    ...
    if os.path.exists(settings_file):
        ...
        fields = [
            ...
            {'field': 'prjct_ttl', 'type': 'String'},
            {'field': 'dept_nm', 'type': 'String'},
