...
write_csv(income_range2, "data/Census/income_range_hh_blockgroup.csv")
print('Saved data/Census/income_range_hh_blockgroup.csv')
...
write_csv(medincome2, "data/Census/medianincome_blockgroup.csv")
print('Saved data/Census/medianincome_blockgroup.csv')
